...
A progressive effort to reconstruct changes in the source O18 concentration would help us get a closer estimate of the original monsoon strength as well as to tease out which artifacts are due to changes in source concentration and which changes are due to anomalies in the monsoon strength.

Some studies, like "Orbital‐scale timing and mechanisms driving Late Pleistocene Indo‐Asian summer monsoons: Reinterpreting cave speleothem δ18O" by Clemens et al. (2018) contend that almost all changes in cave O18 are due to changes in source O18.
